...
import { normalizeFirebasePrivateKey, normalizeFirebaseEnvValue } from './src/utils/firebase-credentials.util.js';
...
async function verifyCredentials() {
  ...
  const projectId = normalizeFirebaseEnvValue(process.env.FIREBASE_PROJECT_ID);
  const clientEmail = normalizeFirebaseEnvValue(process.env.FIREBASE_CLIENT_EMAIL);
