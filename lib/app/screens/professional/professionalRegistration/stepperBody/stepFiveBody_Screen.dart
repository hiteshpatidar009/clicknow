...
class StepFiveBodyScreen extends StatefulWidget {
  ...
  @override
  State<StepFiveBodyScreen> createState() =>
      _StepFiveBodyScreenState();
}
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text("Pricing & Payment Setup", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                  ),
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: 10),
                    child: Text("Set your pricing and payment details for bookings.", style: TextStyle(color: Colors.white60, fontSize: 12),
                    ),
                  ),
  ...
  Widget _pricingSection() {
    return Column(
      ...
      children: [
        ...
        _numberField(controller.basePriceController, "Base Package Price (Rs.)"),
        ...
        Obx(() => Row(
          children: [
            Radio(
              ...
              onChanged: (val) => controller.professionalType.value = val.toString(),
            ),
            Text("Full-Time", style: TextStyle(color: Colors.white.withValues(alpha: 0.6))),
            Radio(
              value: "Freelancer",
              groupValue: controller.professionalType.value,
              onChanged: (val) => controller.professionalType.value = val.toString(),
            ),
            Text("Freelancer", style: TextStyle(color: Colors.white.withValues(alpha: 0.6))),
          ],
        )),
        const SizedBox(height: 16),
        ...
        Obx(() => DropdownButtonFormField(
          value: controller.selectedTeamSize.value.isEmpty ? null : controller.selectedTeamSize.value,
          dropdownColor: const Color(0xff1C1736),
          items: controller.teamSizeOptions.map((e) =>
              DropdownMenuItem(
                value: e,
        ...
        _toggleTile("Willing to travel outside city", controller.willingToTravel),
        _toggleTile("Cancellation Policy", controller.cancellationAccepted),
        _toggleTile("Platform Commission Agreement", controller.commissionAccepted),
      ],
    );
  }
