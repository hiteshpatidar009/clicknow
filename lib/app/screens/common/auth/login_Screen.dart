        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Container(
                width: double.infinity,
                padding: EdgeInsets.symmetric(horizontal: scale.getScaledWidth(16), vertical: scale.getScaledHeight(6)),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(AppStrings.loginDescription, textAlign: TextAlign.center, style: TextStyle(fontSize: scale.getScaledFont(14), color: AppColors.descriptionColor,),),
        ...
        Align(
            ...
            child: Text("Forgot Password?", style: TextStyle(fontSize: scale.getScaledFont(12), color: AppColors.blue, fontWeight: FontWeight.bold,),),
        ),
        ...
        Obx(() => SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: controller.isLoading.value
                ...
                : Text(AppStrings.loginButton, style: TextStyle(fontSize: scale.getScaledFont(16), color: AppColors.buttonForeground, fontWeight: FontWeight.bold,),),
          ),
        )),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10),
                side: BorderSide(color: AppColors.purple3)
              ),
            ),
            child: Text(AppStrings.createAccountButton, style: TextStyle(fontSize: scale.getScaledFont(16), color: AppColors.white, fontWeight: FontWeight.bold,),),
          ),
        ),
        SizedBox(height: scale.getScaledHeight(8)),
        ...
        Row(
          children: [
            Expanded(child: Divider(color: AppColors.dividerColor, indent: 5,  endIndent: 5,)),
            Text("Or, Continue with Google", style: TextStyle(color: AppColors.dividerColor, fontSize: scale.getScaledFont(10)),),
            Expanded(child: Divider(color: AppColors.dividerColor, indent: 5,  endIndent: 5,))
          ],
        ),
        SizedBox(height: scale.getScaledHeight(8)),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Row(
              ...
              children: [
                Image.asset(AppImages.googleIcon, width: scale.getScaledWidth(20), height: scale.getScaledWidth(20),),
                SizedBox(width: scale.getScaledWidth(10)),
                Text(AppStrings.singUpWithGoogleButton, style: TextStyle(fontSize: scale.getScaledFont(16), color: AppColors.white, fontWeight: FontWeight.bold,),),
              ],
            ),
          ),
        ),
